...
(($, _) => {
	$.fn.autofill = function (params) {
		if ('string' == typeof params) {
			if ('destroy' == params) {
				this.off('keyup.autofill');
				this.off('focus.autofill');
				this.off('blur.autofill');
				$('.autofill-wrapper', this).remove();
		...
		let keyMove = {
			...
			clear: function () { list.html(''); this.current = false; return this; },
