...
download_with_version "preact" "https://unpkg.com/preact@latest/dist/preact.module.js.map" $basedir/preact.module.js.map
download_with_version "hooks" "https://unpkg.com/preact@latest/hooks/dist/hooks.module.js" $basedir/hooks.module.js
download_with_version "hooks" "https://unpkg.com/preact@latest/hooks/dist/hooks.module.js.map" $basedir/hooks.module.js.map
