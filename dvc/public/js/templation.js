...
(function() {
	...
	*/
	var cache = {
		...
		tr : '<tr />',
		modal : '<div class="modal"><div class="modal-content" role="dialog" aria-labelledby="modal-header-title"><div class="modal-header"><h1 id="modal-header-title" /></div><i class="fa fa-times close" /><div class="modal-body" /></div></div>',
